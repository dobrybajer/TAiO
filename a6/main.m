...
l_symboli=8;   % unikalne wartoœci z 1-szej kolumny
l_rep=4;       % liczba powtórzeñ powy¿szych
l_cech=5;       % d³ugoœæ s³owa opisuj¹cego dany symbol
l_podzialow=6;  % liczba stanów w automacie
...
zbior_uczacy=LearningFuzzyForeignElemSetGenerator(l_symboli,l_rep,l_cech,l_podzialow,war_oczek,odch_std);
